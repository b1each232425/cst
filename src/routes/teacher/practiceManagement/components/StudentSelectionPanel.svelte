...
<div class={show_panel ? "examinee-panel-container" : "hide"}>
    <div class="examinee-panel">
        <div class="panel-header">
            <span class="panel-header-text">{is_selection_mode ? "选择学生" : "已选择学生"}</span>
            <button
                class="close-btn"
                onclick={() => {
                    show_panel = false;
                ...
                <div class="selected-examinees-container">
                    ...
                    <div class="examinee-selection-table-container">
                        ...
                        {#if filtered_selected_ids.length === 0}
                            <div class="no-data-text">暂无已选学生，请点击添加学生</div>
                        {/if}
                    </div>
            ...
            {:else}
                ...
                <div class="examinee-selection-table-container">
                    ...
                    {#if student_list.length === 0}
                        <div class="no-data-text">暂无学生，请导入学生或到达学生管理添加学生</div>
                    {/if}
                </div>
                <div class="pagination-container">
                    <span style="font-size: 12px; margin-right:10px">
