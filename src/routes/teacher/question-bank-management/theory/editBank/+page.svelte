...
/**
    ...
    const onGoBackToQuestionBankList = () => {
        ...
        goto("/teacher/question-bank-management/theory");
    };
...
onMount(async () => {
        ...
        if (localStorage) {
            ...
            if (question_bank_data_json) {
                ...
                bank_create_time = formatTimestamp(
                    question_bank_data.create_time,
                );
                ...
                bank_update_time = formatTimestamp(
                    question_bank_data.update_time,
                );
