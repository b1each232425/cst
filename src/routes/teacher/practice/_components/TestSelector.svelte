...
<script>
  ...
  let structureOptions = $state(['全部', '自定义组卷', '随机组卷', '智能刷题']);
      ...
      <div class="modal-body">
        <div class="test-table">
          <div class="table-header">
            ...
            <div class="header-cell type-cell">组卷方式(练习类型)</div>
              ...
              {#each currentPageTests as test (test.ID)}
                <div class="table-row">
                  ...
                  <div class="cell diff-cell">
                    <span class={`level ${test.level === '简单' ? 'easy' : test.level === '中等' ? 'medium' : 'hard'}`}>
                      {test.level}
                    </span>
                  </div>
