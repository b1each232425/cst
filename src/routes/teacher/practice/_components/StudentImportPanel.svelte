<!-- 
 /*
 * @Author: 李乐毅 3102128343@qq.com
 * @Date: 2025-07-18 11:48:06
 * @LastEditors: 李乐毅 && 3102128343@qq.com
 * @LastEditTime: 2025-06-15 19:51:07
 * @FilePath: src\routes\teacher\practice\_components\StudentImportPanel.svelte
 * @Description: 学生导入面板
 * Copyright (c) 2025 by 李乐毅, All Rights Reserved. 
 */ 
 -->
<script>
    ...
    import SearchInput from "$lib/components/Input/InputBox.svelte";
    ...
    //每页显示的数据条数
    let page_size = $state(search_params.pageSize);
