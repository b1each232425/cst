 ...
 * @LastEditTime: 2025-07-10 16:03:38
...
<script>
    ...
    // 已选择学生的当前页
    let selected_current_page = $state(1);
...
<div class={show_panel ? "examinee-panel-container" : "hide"}>
    <div class="examinee-panel">
        <div class="panel-header">
            <span class="panel-header-text">{is_selection_mode ? "选择考生" : "已选择考生"}</span>
            <button
                class="close-btn"
                onclick={() => {
                    show_panel = false;
                        ...
                        <tbody>
                            {#each examinee_list as examinee, index}
                                ...
                                >
                                    ...
                                    <td
                                        >{examinee.official_name === null ||
                                        examinee.official_name === ""
                                            ? "--"
                                            : examinee.official_name}</td
                                    >
                                    <td
                                    ...
                                    >
                                    <td
                                        >{examinee.id_card_no === null ||
                                        examinee.id_card_no === ""
                                            ? "--"
                                            : examinee.id_card_no}</td
                                    >
                                </tr>
                            {/each}
                        </tbody>
