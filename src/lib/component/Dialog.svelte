 ...
 * @FilePath: \tutorial-platform-fe\src\lib\component\Dialog.svelte
 * @LastEditTime: 2025-05-02 11:04:09
 -->
        ...
        <div class="dialog-container" style="width: {width}">
            <div class="dialog-header">
                <div class="title-container">
                    <img src="/dialog/tip.svg" alt="提示图标" class="tip-icon" />
            ...
            {#if showFooter}
                <div class="dialog-footer">
                    <button class="cancel-button" onclick={handleCancel}>{cancelText}</button>
                    <button 
