 ...
 * @FilePath: \tutorial-platform-fe\src\lib\component\QuestionEditPanel\shortAnswer.svelte
 * @Description: 题目编辑面板
 * @
-->
<script>
                            ...
                            {#if initialized}
                                <SmartEditor
                                    ...
                                    editor_options={{
                                        ...
                                        placeholder:
                                            "若为单一题目，请直接填写题目内容。  若为主题干附带若干题目，请一并填写所有内容。",
                                        onContentChange: (
                                            /**
                                             * @type {PiptapEditor}
                                             */
    ...
    <div class="container">
        ...
        <div class="content shortAnswerAnswerContent">
            {#each question_answers as answer, index}
                <div
                    class="shortAnswerAnswerRepeaterElement {question_answers_editors_warning[
                        index
                    ][0] !== 0 ||
                    ...
                    <div class="shortAnswerAnswerContainer">
                        ...
                        <div class="shortAnswerAnswerContent">
                            {#if expend_answer_area[index]}
                                <div
                                    class="shortAnswerAnswerContentInputContainer {question_answers_editors_warning[
                                        index
                                    ][0] !== 0
                                        ? 'warning'
                                        : ''}"
                                ...
                                <div
                                    class="shortAnswerAnswerScoreInputContainer {question_answers_editors_warning[
                                        index
                                    ][1] !== 0
                                        ? 'warning'
                                        : ''}"
                                ...
                                <div
                                    class="shortAnswerAnswerGradingRuleInputContainer {question_answers_editors_warning[
                                        index
                                    ][2] !== 0
                                        ? 'warning'
                                        : ''}"
