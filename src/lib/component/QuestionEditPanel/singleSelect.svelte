 ...
 * @LastEditTime: 2025-05-24 17:44:20
 * @FilePath: \tutorial-platform-fe\src\lib\component\QuestionEditPanel\singleSelect.svelte
 * @Description: 单选题 题目编辑面板
 * @
-->
<script>
    ...
    export const initPanel = () => {
        ...
        // 设置富文本编辑器内容
        title_editor?.setContentWithoutHistory(question_data?.content || "");
...
<div class="editorContainer {show ? '' : 'hide'}">
    <div class="topBar">
        <span>{is_new_question ? `新增` : `编辑`}单选题</span>
