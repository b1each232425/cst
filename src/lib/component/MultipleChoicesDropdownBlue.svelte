 ...
 * @Date: 2025-04-10 17:19:57
 * @LastEditors: 宇昕 马 1243805308@qq.com
 * @LastEditTime: 2025-04-10 17:58:06
 * @FilePath: \tutorial-platform-fe\src\lib\component\MultipleChoicesDropdownBlue.svelte
 * @Description: 一个支持多选的蓝色下拉框组件
 *
