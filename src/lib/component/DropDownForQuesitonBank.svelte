 ...
 * @LastEditTime: 2025-05-25 16:20:28
 * @FilePath: \tutorial-platform-fe\src\lib\component\DropDownForQuesitonBank.svelte
 * @Description: 蓝色下拉框组件——理论题库定制版
 * @Props:
...
<div class="dropdown-container">
    ...
    >
        ...
        <svg
            class={is_open ? "icon-rotated" : "icon"}
            viewBox="0 0 24 24"
            fill="#0336ff"
            width="20"
            height="20"
