 ...
 * @LastEditTime: 2025-05-05 22:09:48
 * @FilePath: \exam-fe\src\lib\Login.svelte
 * @Description: 登录组件
...
<script>
     ...
     *      qr_code?: import("svelte").Snippet;            // 二维码组件
     ...
     * }}
     */
    let { logo, qr_code, public_user_agreement_url, public_privacy_policy_url, public_product_service_agreement_url, handle_funcs } = $props();
    ...
    $effect(()=>{
        ...
        switch(active_tab) {
            case "phone":
                document.documentElement.style.setProperty('--active-tab-position', '0px');
                break;
            case "account":
                document.documentElement.style.setProperty('--active-tab-position', '100%');
                break;
            default:
                document.documentElement.style.setProperty('--active-tab-position', '0px');
                break;
        ...
        if (active_tab === "account") {
            ...
            try {
                ...
                if (!response.ok) {
                    ...
                    loginError = await response.text()|| "登录失败，请检查账号和密码";
                    return;
                }
                ...
                if (result && result.status === 0) {
                    ...
                    // 登录失败，显示错误信息
                    loginError = result.msg || "登录失败，请检查账号和密码";
                }
            } catch (error) {
            ...
            const verificationCodeInput = document.querySelector('.verification-code-input-field');
    ...
    function handleMicrosoftLoginClick() {
        ...
        window.location.href = `${window.location.protocol}//${window.location.hostname}:${serverPort}/api/oauth/login/microsoft?role=1&target=/teacher/questionBank/theory`;
    }
...
{#snippet defaultQRCode()}
    <img class="QR-code" style="width: 80%;" alt="example" />
{/snippet}
        ...
        <div class="login-left-container">
            ...
            <div class="login-content">
                ...
                <div class="login-method-switch-tab" >
                    ...
                    <button class="login-method-phone" class:active={active_tab === "phone"}
                    ...
                    <button class="login-method-account" class:active={active_tab === "account"}
                ...
                <div class="login-input-container">
                    ...
                    {#if active_tab == "phone"}
                        ...
                        <div class="phone-input">
                            ...
                            <input type="text" placeholder="请输入手机号" class="phone-input-field" maxlength="11" />
                        ...
                        <div class="phone-verification-code-input">
                            ...
                            <input type="text" placeholder="请输入验证码" class="verification-code-input-field" maxlength="11" />


                            <button id="reacquire-code-btn"
                    ...
                    {:else if active_tab == "account"}
                        ...
                        <div class="account-input">
                            <input type="text" placeholder="请输入账号或手机号" class="account-input-field" bind:value={identifier} />
                        </div>

                        <div class="password-input">
                            <input required type="password" placeholder="请输入密码" class="password-input-field" bind:value={password} />
                        </div>
                ...
                <div class="user-agreement">
                    ...
                    <div class="user-agreement-content">
                        ...
                        <div style="display: flex; align-items: center;">
                            <input type="checkbox" id="user-agreement-checkbox" style="color:#0052d9; cursor: pointer; margin-right: 5px;" bind:checked={user_agreement_is_checked}/>

                            <div class="user-agreement-text" style="display: flex; align-items: center; border: none;">
                                ...
                                <button style="
                                    ...
                                    cursor: pointer;
                                    white-space: nowrap;"
                                        onclick={() => user_agreement_is_checked = !user_agreement_is_checked}
                                >
                                ...
                                <span style="
                                    display: flex;"
                                >
                                    <a href={public_user_agreement_url} target="_blank">用户协议</a>、<a href={public_privacy_policy_url} target="_blank">隐私政策</a>、<a href={public_product_service_agreement_url} target="_blank">产品服务协议</a>
                                </span>
        ...
        <div class="register-content">
            ...
            <div class="contact-info">
                ...
                <div style="
                    ...
                    width: 100%;
                    justify-content: center;">
                    <img class="QR-code" src="normal_u7.png" style="width: 28%;" alt="example" />
                </div>
...
<style lang="scss" scoped>
  ...
  .login-right-container .qr-code-container{
    display: flex;
    width: 100%;
    justify-content: center;
    align-items: center;
  ...
  .login-method-phone, .login-method-account {
    width: 37.5%;
    margin-top: 4px;
    margin-bottom: 4px;
    border-radius: 3px;
  ...
  .login-method-phone.active, .login-method-account.active {
    color: #0052d9;
  }
  ...
  .phone-input, .phone-verification-code-input, .account-input, .password-input {
    position: relative;
    top: 5%;
    display: flex;
    width: 100%;
  ...
  .phone-verification-code-input, .password-input {
    top: 25%;
  }
  ...
  .phone-input-field, .verification-code-input-field, .account-input-field, .password-input-field {
    position: relative;
    width: 60%;
    height: 100%;
    padding: 2px 2px 2px 2px;
  ...
  .account-input-field, .password-input-field {
    width: 75%;
  }

  .login-error-message, .agreement-error-message {
    position: absolute;
    top: 55%;
    width: 75%;
    margin: 5px auto;
  ...
  .forget-account, .forget-password {
    border: none;
    height: max-content;
    color: #8f8f8f;
    background-color: rgba(255, 255, 255, 0);
  ...
  .forget-account:hover, .forget-password:hover {
    color: #0052d9;
